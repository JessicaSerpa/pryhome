...
public class DaoEmpleados {
 ...
 public List<Usuario> getAllEmpleados(){
     ...
     try{
      String sql="select  id_usuario,nom_usuario,correo, pass_usuario, telefono, direccion, dni, tipo_usuario, edad, departamento  from usuario where tipo_usuario='Administrador' ";
 ...
 //buscar por codigo
 public Usuario busEmp(String cod){
    Usuario p=null; 
    ...
    System.out.println("Mensaje de error: " + ex.getMessage());
     ...
     return p;
      ...
      //añadir    id_usu
 public void adicionEmp(Usuario a){
  Connection cn=MySQLConexion.getConexion();
  try{
  String sql = "{call spadiEmpleado(?, ?, ?, ?, ?, ?, ?, ?)}";
...
public void cambiaEmp(Usuario a){
  Connection cn=MySQLConexion.getConexion();
  try{
...
public void borraEmp(String cod){
  Connection cn=MySQLConexion.getConexion();
  try{                              
